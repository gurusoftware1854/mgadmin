...
const Sidebar = () => {
  ...
  // console.log("isShowPopper",isShowPopper)
            ...
            <div class="flex flex-col items-center space-y-3 py-3">
              ...
              >
                ...
                <div
                  ...
                  class={`popper-root fixed ${isShowPopper ? "show" : ""}`}
                  // x-ref="popperRoot"
                  ref={popperRef}
                >
          ...
          <div class="flex h-full grow flex-col bg-white pl-[var(--main-sidebar-width)] dark:bg-navy-750">
            ...
            >
              <ul class="flex flex-1 flex-col px-4 font-inter">
                <li>
                  <Link
                    to={`${selectedScheme}_master_report`} 
                    className={`flex py-2 text-xs-plus tracking-wide outline-hidden transition-colors duration-300 ease-in-out ${
                      activeLink
                    ...
                    onClick={() => setIsSidebarExpanded(false)} 
                  >
                    {`${selectedScheme} Master Report`}
                   
                  </Link>
                </li>
                <li>
                  <Link
                    to={`${selectedScheme}_report`} // Change 'href' to 'to' for React Router, or use <a> if needed
                    className={`flex py-2 text-xs-plus tracking-wide outline-hidden transition-colors duration-300 ease-in-out ${
                      activeLink
                        ? "font-medium text-primary dark:text-accent-light"
                        : "text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50"
                    }`}
                    onClick={() => setIsSidebarExpanded(false)} // Example logic to activate link
                  >
                    {`${selectedScheme} Report`}
