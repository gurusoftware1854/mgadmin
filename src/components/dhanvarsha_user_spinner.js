...
const DhanvarshaUserSpinner = ({ onSelect, selectedUser, setSelectedUser }) => {
    ...
    const fetchUsers = async () => {
      try {
        const response = await apiClient.post(
          `${baseUrl}/dhanvarsha/get_dhanvarsha_users.php`
        );
...
export default DhanvarshaUserSpinner;
